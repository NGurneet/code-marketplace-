...
import { showSuccessToast, showErrorToast, showLoadingToast } from "../utils/toast-utils/toast.utils";
  ...
  return (
    <Box
      sx={{
        ...
        minHeight: "100vh",
        backgroundImage: "url('/assets/loginBackground.jpg')", // Change the path as needed
